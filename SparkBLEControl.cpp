...
void SparkBLEControl::notifyClients(ByteVector msg){
	...
	if(pSvc) {
		...
		if(pChr) {
			pChr->setValue(static_cast<uint8_t*>(&msg.data()[0]),msg.size());
			pChr->notify(true);
		}
	}
}
...
void SparkBLEControl::sendInitialNotification(){
	...
	ByteVector preface1 ={0x01, 0xFE, 0x00, 0x00, 0x41, 0xFF, 0x1D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0xF0, 0x01, 0x01, 0x77, 0x03, 0x2F, 0x11, 0x4E, 0x01, 0x04, 0x03, 0x2E, 0xF7};
	ByteVector preface2 = {0x01, 0xFE, 0x00, 0x00, 0x41, 0xFF, 0x1E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	...
	ByteVector preface3 = {0x01, 0xFE, 0x00, 0x00, 0x41, 0xFF, 0x29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
