...
#elif BATTERY_TYPE == BATTERY_TYPE_AMP // Level between 3400(?) and 4095
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_90 = (BATTERY_MIN_LEVEL + (BATTERY_MAX_LEVEL - BATTERY_MIN_LEVEL) * 0.9);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_50 = (BATTERY_MIN_LEVEL + (BATTERY_MAX_LEVEL - BATTERY_MIN_LEVEL) * 0.5);
