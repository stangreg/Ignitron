...
// TODO: Find and process real messages as requested by app
	...
	// Version number
	ByteVector preface2_1_4_3_174 = { 0x01, 0xFE, 0x00, 0x00, 0x41, 0xFF, 0x1D,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x01, 0x01,
			0x77, 0x03, 0x2F, 0x11, 0x4E, 0x01, 0x04, 0x03, 0xAE, 0xF7 };

	ByteVector preface2_1_5_4_102 = { 0x01, 0xFE, 0x00, 0x00, 0x41, 0xFF, 0x1D,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF0, 0x01,
			0x01, 0x29, 0x03, 0x2F, 0x01, 0x4E, 0x01, 0x05, 0x04, 0x66, 0xF7 };
	...
	if (pServer->getConnectedCount()) {
		...
		case 1:
			...
			break;
		case 2:
			notifyClients(preface2_1_4_3_174);
			delay(delayValue);
			break;
		case 3:
