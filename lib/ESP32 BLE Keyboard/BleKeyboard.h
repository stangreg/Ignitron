...
class BleKeyboard : public Print, BLEServerCallbacks, BLECharacteristicCallbacks {
private:
    BLEHIDDevice *hid;
...
protected:
    ...
    virtual void onConnect(BLEServer *pServer, NimBLEConnInfo &connInfo);
    virtual void onDisconnect(BLEServer *pServer, NimBLEConnInfo &connInfo, int reason);
    virtual void onWrite(BLECharacteristic *me, NimBLEConnInfo &connInfo);
};
